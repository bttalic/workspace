...
public class JosJedanGolemiZadatak {
	 ...
	 *            koju provjeravamo
	 * 
	 * @return Vraca vrijednost true ako u matrici ima bar jedna 0, u suprotnom
	 *         vraca vrijednost false
	 */
	...
	public static void main(String[] args) {
		...
		do {
			...
			for (int i = 0; i < matrica[0].length; i++) {
				...
				if (sviIstiKolona(matrica, i) == true && matrica[0][matrica.length-1] != 0) {
