...
public class ArrayUtil {
	...
	/**
	 * Funkcija pravi 1D niz, u njega ulazi inter koji definise velicinu niza a
	 * zatim korisnik popunjava vrijednosti niza i vraca gotov niz
	 * 
	 * @param size
	 * @return
	 */
	...
	/**
	 * Funkcija pravi 1D niz, u njega ulazi integer koji definise velicinu niza
	 * i vrijednost kojom ce se popuniti citav niz i zatim vraca gotov niz.
	 * 
	 * @param size
	 * @param defaultValue
	 * @return
	...
	/**
	 * Funkcija prilagodi drugi niz duzinom i izvrsi kopiranje iz niza1 u niz2
	 * 
	 * @param niz1
	 * @param niz2
	 * @return
	...
	public static void bubbleSort(int[] arr) {
	 ...
	 public static int[] getColumn(int[][] matrix, int columnIndex){
		 int [] nizKolone= new int [columnIndex];
		 for (int i=0;i<matrix.length;i++){
			 nizKolone[i]=matrix[i][columnIndex];
